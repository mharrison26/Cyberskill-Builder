...
export const MOCK_TRACK_TICKETS: MockTrackTicket[] = [
  ...
  // —— Python Engineering ——
  {
    id: 'py-tkt-001',
    trackSlug: 'python',
    title: 'Parse authz log anomalies into OSCAL observations',
    subtitle: '#142 · scoring harness',
    ticketType: 'code_lab',
    difficulty: 'high',
    slaMinutes: 480,
    startedAt: startedMinutesAgo(90),
    status: 'in_progress',
    labels: ['oscal', 'parser', 'tier-2'],
    dcwfCode: '621',
    sortOrder: 1,
  },
  {
    id: 'py-tkt-002',
    trackSlug: 'python',
    title: 'Add unit tests for POA&M date math',
    subtitle: '#138 · good first issue',
    ticketType: 'code_lab',
    difficulty: 'medium',
    slaMinutes: 240,
    startedAt: null,
  ...
  },
  {
    id: 'py-tkt-003',
    trackSlug: 'python',
    title: 'Fix flaky SLA countdown fixture',
    subtitle: '#151 · bug',
    ticketType: 'code_lab',
    difficulty: 'low',
    slaMinutes: 120,
    startedAt: startedMinutesAgo(40),
    status: 'in_progress',
    labels: ['bug', 'sla'],
    dcwfCode: '621',
    sortOrder: 3,
  },
  {
    id: 'py-tkt-004',
    trackSlug: 'python',
    title: 'CLI: export ticket matrix as CSV',
    subtitle: '#129 · enhancement',
    ticketType: 'code_lab',
    difficulty: 'medium',
    slaMinutes: 360,
    startedAt: null,
  ...
  },
  {
    id: 'py-tkt-005',
    trackSlug: 'python',
    title: 'Sanitize mock directory dump script',
    subtitle: '#120 · security',
    ticketType: 'code_lab',
    difficulty: 'high',
    slaMinutes: 180,
    startedAt: startedMinutesAgo(160),
    status: 'resolved',
    labels: ['security', 'helpdesk'],
    dcwfCode: '621',
    sortOrder: 5,
  },

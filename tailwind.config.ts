  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        status: {
          satisfied: 'var(--status-satisfied)',
          'satisfied-foreground': 'var(--status-satisfied-foreground)',
          insufficient: 'var(--status-insufficient)',
          'insufficient-foreground': 'var(--status-insufficient-foreground)',
          blocked: 'var(--status-blocked)',
          'blocked-foreground': 'var(--status-blocked-foreground)',
